class Api::V2::ContactsController < Api::BaseController
  ...
  def create_contact_params
    ...
    params.required(:contact).permit(:remote_id, :name, :city, :bio, :birthday, :phone, :gender, :user_id, :added_at, :role, :email)
  end
end
